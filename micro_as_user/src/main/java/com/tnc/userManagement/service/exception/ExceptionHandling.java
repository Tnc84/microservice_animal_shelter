...
public class ExceptionHandling implements ErrorController {
    ...
    public static final String METHOD_IS_NOT_ALLOWED = "This request method is not allowed on this method. please send a '%s' request";
...
//throw when the endpoint type is wrong(GET / POST / PUT etc...)
